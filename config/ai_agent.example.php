...
return [
    ...
    'api_key' => getenv('AI_AGENT_API_KEY') ?: 'replace-with-your-ai-api-key',
    ...
    'sensitive_access_password' => getenv('AI_AGENT_SENSITIVE_PASSWORD') ?: 'replace-with-sensitive-access-password',
