...
<body>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="../../admin/dashboard.html">Grafik /
                                    Informasi</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="../../admin/barang/data-barang.php">Item
                                    Data</a>
                            </li>
                            <li class="nxl-item"><a class="nxl-link" href="../../admin/barang/detail-barang.html">Item
                                    Detail</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="../../admin/peminjaman/data-peminjaman.html">Request Loan</a>
                            </li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="../../admin/peminjaman/sedang-dipinjam.html">List Loan</a>
                            </li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="../../admin/peminjaman/admin-approval.html">Approval</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="../../admin/pengembalian/pengembalian-barang.html">Return Loan</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="../../admin/user/buat-user.html">User
                                    List</a>
                            </li>
    ...
    <main class="nxl-container">
        <div class="nxl-content">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-nowrap align-items-center gap-2 mb-3">
                            <button class="btn btn-success btn-sm" onclick="exportUsersCSV()" title="Download CSV">
                            ...
                            <button class="btn btn-sm btn-outline-secondary" onclick="loadUsers()" title="Refresh">
                                <i class="feather-refresh-cw"></i>
                            </button>
                            <button class="btn btn-primary btn-sm" onclick="openChangePasswordFromToolbar()">
                                <i class="feather-lock me-1"></i> Change Password
                            </button>
                        </div>

                        <!-- Showing entries info -->
                        <p class="text-muted fs-12 mb-2" id="showingInfo">Showing 0 entries</p>

                        <!-- User Table Card -->
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered align-middle mb-0" id="userTable">
                                        <thead>
                                            <tr style="background: #3b5998; color: #fff !important;">
                                                ...
                                                <th style="cursor:pointer; color: #fff !important;"
                                                    onclick="sortTable('nama')">
                                                    Name <i class="feather-arrow-up fs-10" id="sort-nama"></i>
                                                </th>
                                                ...
                                                <th width="10%" style="color: #fff !important;">Action</th>
                                            </tr>
                                            <tr style="background: #4a69bd;">
                                                <td></td>
                                                <td><input type="text" class="form-control form-control-sm border-0"
                                                        id="filterName" placeholder="Filter name..."
                                                        oninput="applyFilters()"></td>
                                                <td><input type="text" class="form-control form-control-sm border-0"
                                                        id="filterNrp" placeholder="Filter NRP..."
                                                        oninput="applyFilters()"></td>
                                                <td><input type="text" class="form-control form-control-sm border-0"
                                                        id="filterEmail" placeholder="Filter email..."
                                                        oninput="applyFilters()"></td>
                                                <td>
                                                    <select class="form-select form-select-sm border-0" id="filterRole"
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <select class="form-select form-select-sm" style="width:75px;" id="perPage"
            ...
            <!-- Modal ADD USER (Komatsu portal style) -->
            <div class="modal fade" id="modalTambahUser" tabindex="-1">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <form id="formTambahUser">
                            <div class="modal-header border-bottom-0 pb-0">
                                <h5 class="modal-title fw-bold text-uppercase">ADD USER</h5>
                            </div>
                            <div class="modal-body pt-2">
                                <hr class="mt-0 mb-3">
                                <!-- Row 1: Role Group + (kosong/Company placeholder) -->
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Role Group<span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="roleGroup" name="roleGroup"
                                            onchange="syncRole()">
                                    ...
                                    <div class="col-md-6">
                                        <!-- Placeholder to match portal layout -->
                                    </div>
                                </div>
                                <!-- Row 2: Name + Role -->
                                <div class="row mb-3">
                                ...
                                <!-- Hidden confirm password (auto-filled) -->
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form id="formChangePassword">
                            <div class="modal-header border-bottom-0 pb-0">
                                <h5 class="modal-title fw-bold text-uppercase">CHANGE PASSWORD</h5>
                            </div>
                            <div class="modal-body pt-2">
                                <hr class="mt-0 mb-3">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Select User</label>
                                    <select class="form-select" id="cpUserId" required>
                                        <option value="">-- Select User --</option>
                                    </select>
                                    <small class="text-muted d-block mt-2">Format: Name (NRP)</small>
                                </div>
                                <div class="mb-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Name</label>
                                <input type="text" class="form-control" id="editUserNameField">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">NRP</label>
                                <input type="text" class="form-control" id="editUserNrpField" >
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Current Role</label>
                                <input type="text" class="form-control" id="editCurrentRoleField" readonly>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="saveUserRoleChanges()">
            ...
            <div class="modal fade" id="modalFeedback" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p id="modalMessage">Message will be displayed here</p>
                        </div>
                        <div class="modal-footer">
        ...
        <!-- [ Footer ] start -->
        <footer class="footer">
            <p class="fs-11 text-muted fw-medium text-uppercase mb-0 copyright text-center">
                <span>Copyright ©</span>
                <script>
    ...
    <!---END KONEKSI KE API.JS-->
    <!--KONEKSI KE USER.JS-->
    <script src="../../assets/js/user/user.js"></script>
    <!---END KONEKSI KE USER.JS-->
