            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Item Data</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="../dashboard.html">Home</a></li>
                        <li class="breadcrumb-item">Item / Inventory</li>
                        <li class="breadcrumb-item">Item Data</li>
                    </ul>
                </div>
                    ...
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered align-middle mb-0" id="barangTable">
                                    <thead>
                                        <tr style="background: #3b5998; color: #fff !important;">
                                            <th class="text-center" style="color: #fff !important;">Select</th>
                                            <th style="color: #fff !important;">No</th>
                                            <th style="color: #fff !important;">Item Code</th>
                                            <th style="cursor:pointer; color: #fff !important;" onclick="sortTable('nama_barang')">
                                                Item Name <i class="feather-arrow-up fs-10" id="sort-nama_barang"></i>
                                            </th>
                                            <th style="color: #fff !important;">Category</th>
                                            <th style="color: #fff !important;">Location</th>
                                            <th style="color: #fff !important;">Safety Stock</th>
                                            <th style="color: #fff !important;">Stock</th>
                                            <th style="color: #fff !important;">Condition</th>
                                            <th style="color: #fff !important;">Status</th>
                                            <th class="text-center" style="color: #fff !important;">Action</th>
                                        </tr>
                                        <tr style="background: #4a69bd;">
                                            <td></td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterNo" placeholder="Filter no..." oninput="applyFilters()">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterItemCode" placeholder="Filter item code..." oninput="applyFilters()">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterItemName" placeholder="Filter item name..." oninput="applyFilters()">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterCategory" placeholder="Filter category..." oninput="applyFilters()">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterLocation" placeholder="Filter location..." oninput="applyFilters()">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm border-0"
                                                    id="filterSafetyStock" placeholder="Filter safety stock..." oninput="applyFilters()">
                                            </td>
                                            <td></td>
                                            <td>
                                                <select class="form-select form-select-sm border-0" id="filterCondition" onchange="applyFilters(true, false)">
                                                    <option value="">All</option>
                                                </select>
                                            </td>
                                            <td>
                                                <select class="form-select form-select-sm border-0" id="filterStatus" onchange="applyFilters(true, false)">
                                                    <option value="">All</option>
                                                </select>
                                            </td>
                                            <td></td>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select form-select-sm" style="width:75px;" id="perPage" onchange="changePerPage()">
