...
class PublicReportService
{
    ...
    private function clientIpForAudit(Request $request): string { return $request->ip() ?? 'unknown'; }
    private function deviceIdForAudit(Request $request): string { return (string) ($request->cookie('laporin_device_id') ?: 'unknown'); }
