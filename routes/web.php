...
Route::middleware(['auth','active'])->group(function () {
    ...
    Route::middleware('role:superadmin')->prefix('admin')->name('admin.')->group(function () {
        Route::get('/users',[SuperadminAdminController::class,'users'])->name('users.index'); Route::post('/users',[SuperadminAdminController::class,'storeUser'])->name('users.store'); Route::put('/users/{user}',[SuperadminAdminController::class,'updateUser'])->name('users.update'); Route::delete('/users/{user}',[SuperadminAdminController::class,'destroyUser'])->name('users.destroy'); Route::get('/audit',[SuperadminAdminController::class,'audit'])->name('audit'); Route::get('/qrcodes',[QRCodeController::class,'index'])->name('qrcodes.index'); Route::post('/qrcodes',[QRCodeController::class,'store'])->name('qrcodes.store'); Route::get('/qrcodes/{qrCode}/download',[QRCodeController::class,'download'])->name('qrcodes.download'); Route::post('/qrcodes/{qrCode}/deactivate',[QRCodeController::class,'deactivate'])->name('qrcodes.deactivate'); Route::get('/master/{resource}',[SuperadminAdminController::class,'master'])->name('master.index'); Route::post('/master/{resource}',[SuperadminAdminController::class,'store'])->name('master.store'); Route::put('/master/{resource}/{id}',[SuperadminAdminController::class,'update'])->whereNumber('id')->name('master.update'); Route::delete('/master/{resource}/{id}',[SuperadminAdminController::class,'destroy'])->whereNumber('id')->name('master.destroy');
    });
    Route::middleware('role:kesiswaan')->prefix('kesiswaan')->name('kesiswaan.')->group(function (): void { Route::get('/',[KesiswaanRoleController::class,'index'])->name('index'); Route::post('/reports/{report}/process',[KesiswaanRoleController::class,'process'])->name('process'); Route::post('/reports/{report}/reject',[KesiswaanRoleController::class,'reject'])->name('reject'); Route::post('/reports/{report}/complete',[KesiswaanRoleController::class,'complete'])->name('complete'); });
    Route::middleware('role:sarpras')->prefix('sarpras')->name('sarpras.')->group(function () { Route::get('/',[SarprasRoleController::class,'index'])->name('index'); Route::post('/reports/{report}/process',[SarprasRoleController::class,'process'])->name('process'); Route::post('/reports/{report}/reject',[SarprasRoleController::class,'reject'])->name('reject'); });
});
