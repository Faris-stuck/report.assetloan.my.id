...
@php
    ...
    $faqs = [
        ...
        ['q' => 'Bagaimana cara lapor pembullyan atau perundungan?', 'a' => 'Buka halaman Buat Laporan, pilih Perundungan / Pelanggaran, isi data pelapor, tanggal kejadian, lalu tulis kronologinya. Sebutkan tempat dan waktu kejadian di dalam kronologi, dan lampirkan bukti bila ada, kemudian kirim laporan. Setelah terkirim, simpan nomor laporan dan kode akses untuk pelacakan.'],
