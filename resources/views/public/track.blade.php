        ...
        <div class="laporin-card p-4 p-lg-5">
            ...
            <form method="POST" action="{{ route('track.search') }}" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input id="report_number" name="report_number" value="{{ old('report_number') }}" class="form-control @error('report_number') is-invalid @enderror" placeholder="LAP-ABC234-XYZ789" required autocomplete="off" autocapitalize="characters" spellcheck="false" enterkeyhint="next" maxlength="24" aria-describedby="report-number-help" data-normalize-report-number>
                    @error('report_number')
                ...
                <div class="col-12">
                    ...
                    <input id="access_code" name="access_code" value="{{ old('access_code') }}" class="form-control @error('access_code') is-invalid @enderror" inputmode="numeric" required autocomplete="one-time-code" enterkeyhint="search" placeholder="Contoh: 123456" maxlength="16" aria-describedby="access-code-help" data-normalize-access-code>
                    @error('access_code')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
