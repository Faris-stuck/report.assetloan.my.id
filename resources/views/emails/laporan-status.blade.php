...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 20px;"><tr><td style="vertical-align:middle;"><img src="{{ asset('images/branding/logo tb.png') }}" alt="Logo SMK Taruna Bangsa" width="52" height="52" style="display:block;width:52px;height:52px;object-fit:contain;background:#ffffff;border-radius:10px;padding:4px;"></td><td style="padding-left:12px;vertical-align:middle;"><p style="margin:0;font-size:20px;line-height:28px;font-weight:bold;">LAPORIN — Notifikasi Laporan</p></td></tr></table>
